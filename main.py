...
env.set_spot_weights('uniform', repaints = 10) # Uniform weighting
...
lr_rast_dist, lr_rast_wmse = env.sim(period, 'lr_rast', starting_phase= starting_phase) 

# Right to left raster scan
rl_rast_dist, rl_rast_wmse = env.sim(period, 'rl_rast', starting_phase= starting_phase) 
